...
DRIVER_MANIFEST = {
  name         = "ctek-chargestorm-v2",
  version      = "0.2.0",
  role         = "ev",
  display_name = "CTEK Chargestorm (API v2)",
  manufacturer = "CTEK",
  protocols    = { "modbus" },
  connection_defaults = {
    port    = 502,
  ...
  verification = {
    status = "beta",
    notes  = "Register map per CTEK Automation interface v1.0 (API v2 offsets); charging-limit write verified against CSOS 4.9.x. Derived charging/connected flags approximate the real EVSE state since the state code is MQTT-only.",
  },
  requires = {},
  options = {
