...
DRIVER_MANIFEST = {
  ...
  version      = "1.0.0",
  role         = "heat-pump",
  display_name = "NIBE REST API S-series",
  manufacturer = "NIBE",
  protocols    = { "http" },
  connection_defaults = { host = "", port = 8443 },
  tested_models = { "NIBE S735" },
  verification = { status = "beta" },
  requires = {
    { name = "host", purpose = "always", type = "string",
      help = "LAN IP of the heat pump (the Local REST API listens on HTTPS)." },
    { name = "username", purpose = "always", type = "string",
      help = "Local-API username (HTTP Basic auth). Created in the myUplink app under local API access." },
    { name = "password", purpose = "always", type = "string", secret = true,
      help = "Local-API password. Stored masked." },
  },
  options = {
    { name = "port", purpose = "always", type = "integer", default = 8443, min = 1, max = 65535,
      help = "HTTPS port of the Local REST API. NIBE default 8443." },
    { name = "device_id", purpose = "always", type = "string",
      help = "Pump serial. Auto-detected from the API when omitted." },
    { name = "poll_interval_ms", purpose = "always", type = "integer", default = 60000, min = 5000, max = 3600000,
      help = "Telemetry poll cadence in ms." },
    { name = "param_power_id", purpose = "always", type = "string",
      help = "Variable id for compressor/used power. S735 default; find yours via GET /api/v1/devices/<serial>/points." },
    { name = "param_hw_temp_id", purpose = "always", type = "string",
      help = "Variable id for hot-water top temperature." },
    { name = "param_indoor_temp_id", purpose = "always", type = "string",
      help = "Variable id for room temperature." },
    { name = "param_outdoor_temp_id", purpose = "always", type = "string",
      help = "Variable id for outdoor temperature." },
  },
  provides = {
    static = { "make", "sn" },
  },
